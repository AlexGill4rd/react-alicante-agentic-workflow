...
| i18n        | next-intl                                            | react-i18next, none                                           | `audit-i18n`, `engineering-new-component`, `audit-test-coverage`                                                                                                                                          | `feature-builder`, `feature-planner`, `bug-triager`, `accessibility-auditor`               |
